...
We will further split the training data set into two: one for training and the other for cross-validation. The p=0.15 is included to minimize the modeling time.
```{r}
set.seed(1234)
